...
2. Перейдите в папку ПК клиента:
   ...
   cd gamedesk_pc
   ```
3. **Рекомендуется создать виртуальное окружение**, чтобы не засорять систему библиотеками:
   ```bash
   python -m venv venv
   # Активация для Windows:
   venv\Scripts\activate
   ```
4. Установите зависимости (убедитесь, что виртуальное окружение активировано):
   ```bash
...
6. Запустите основной скрипт (либо собранный `GameDesk.exe`, если он уже скомпилирован):
   ```bash
   python main.py
   ```
