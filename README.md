...
Код для ESP32 находится в папке `GameDesk_ESP32`. Если вы настраиваете Arduino IDE с нуля, выполните следующие шаги:

1. Установите [Arduino IDE](https://www.arduino.cc/en/software) (рекомендуется версия 2.x).
...
3. **Установите библиотеку дисплея:**
...
4. **Настройте библиотеку дисплея:**
